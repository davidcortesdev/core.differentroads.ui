...
![Formulario de Registro](./01-formulario-registro.png)
...
![Email de Confirmación](./02-email-verificacion.png)
...
![Verificación de Código](./03-codigo-verificacion.png)
...
![Dashboard Principal](./05-dashboard-principal.png)
