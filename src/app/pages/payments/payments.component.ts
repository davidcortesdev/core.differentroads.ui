...
export class PaymentsComponent implements OnInit {
  ...
  // Método para seleccionar tipo de pago al hacer clic en el panel completo
  selectPaymentType(type: string): void {
    this.paymentType = type;
    this.onPaymentTypeChange();
  }

  // Método para seleccionar método de pago al hacer clic en el panel completo
  ...
  // Continuación de redirectToRedSys...
